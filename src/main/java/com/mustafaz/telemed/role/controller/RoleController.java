package com.mustafaz.telemed.role.controller;

import com.mustafaz.telemed.res.Response;
import com.mustafaz.telemed.role.entity.Role;
import com.mustafaz.telemed.role.service.RoleService;
...
public class RoleController {
    ...
    public ResponseEntity<Response<Role>> createRole(@RequestBody Role roleRequest) {
        ...
        Response<Role> createdRole = roleService.createRole(roleRequest);
